...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Votre rendez-vous a été confirmé avec succès. Voici un récapitulatif :</p>
            ...
            <div class="appointment-details">
                ...
                <p><strong>Prix :</strong> <?php echo number_format($appointment->getPrice(), 2, ',', ' '); ?> €</p>
            ...
            <p>
                <a href="<?php echo esc_url($site_url); ?>" class="button">Voir mon rendez-vous</a>
            </p>
