...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #f9f9f9; padding: 30px; border-radius: 5px; border: 1px solid #e5e5e5;">
        <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #2c3e50; margin: 0 0 20px 0;"><?php echo esc_html__('Confirmation de rendez-vous', 'calendrier-rdv'); ?></h1>
        </div>
        ...
        <div style="background-color: #fff; padding: 25px; border-radius: 5px; border: 1px solid #e5e5e5; margin-bottom: 25px;">
            ...
            <p>
                <?php echo esc_html__('Si vous avez des questions ou souhaitez modifier votre rendez-vous, n\'hésitez pas à nous contacter.', 'calendrier-rdv'); ?>
            </p>
        </div>
